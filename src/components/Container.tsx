...
export default function Container() {
  const { step, currentQuestion } = useSurveyContext();
  return (
    <div className="w-full sm:w-[90%] sm:min-h-[600px] min-h-screen bg-white flex flex-col sm:flex-row justify-center">
      <section className="flex-1/2 relative px-10 py-10 sm:py-5">
        ...
        <div className="flex flex-col justify-center items-center gap-5 sm:gap-7  h-full relative z-1 text-white text-center">
          ...
          <p className="font-light text-white/50 text-sm sm:text-md lg:w-[80%]">
            Participez à notre enquête de satisfaction pour nous aider à
            améliorer notre service après-vente. Répondez simplement aux
            questions et partagez votre avis en quelques minutes.{" "}
          </p>
      ...
      <section className="flex-1/2 bg-white text-center flex flex-col justify-center px-8 lg:px-20 min-h-[400px]">
